...
<body>
	...
	<table>
		...
		<tr>
			<td>Tim Pembimbing</td>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td>
				<ol style="margin-left: -25px;">
					<li><?= $skripsi->pembimbing_satu_name; ?></li>
					<li><?= $skripsi->pembimbing_dua_name; ?></li>
				</ol>
			</td>
		</tr>
		<tr>
	...
	<p>Telah Melakukan Pengujuan SKRIPSI Bagi Mahasiswa : </p>
	<table>
		<tr>
			<td>Nama</td>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		...
		<tr>
			<td>Nilai</td>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td><?= $skripsi->total_pem; ?></td>
		</tr>
		<tr>
			<td>Predikat</td>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td><?= $skripsi->total_peng; ?></td>
		</tr>
	</table>
	<center>
