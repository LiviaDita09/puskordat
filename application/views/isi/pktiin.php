    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800" style="margin-top: 15px;">Pendaftaran & Kelengkapan Praktik Kerja Teknologi Informasi (Internal)</h1>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="card shadow mb-4" style="width: 1078px;">
                        ...
                        <form method="post" action="<?php echo base_url('pktiInternal/saveData'); ?>" id="form-data">
                                    ...
                                    <div>
                                        <h4 class="small font-weight-bold text-left" style="margin-bottom: 45px; margin-left: 40px;">
                                            ...
                                            <span class="float-right">
                                                <input type="text" name="kd_pkti" oninput="kdPMKP(this.value)" style="width: 304px; height: 35px;" />
                    ...
                    <div class="card shadow mb-4" style="width: 1078px; height: 500px;">
                        ...
                        <div class="row text-center">
                            <div class="card-body" style="width: 450px; margin-top: 5px;">
                                <form method="post" action="<?php echo base_url('pktiInternal/saveNilai');?>" id="form-nilai">
                                    <div style="margin-right: 40px; margin-left: 40px;">
                                        <input type="hidden" id="kd_pkti_nilai" name="kd_pkti_nilai">
                                        ...
                                        <h4 class="small font-weight-bold text-left" style="margin-left: 20px; margin-bottom: 30px; margin-right: 5px;">
                                            Aplikasi Program (Kinerja Magang)
                                        ...
                                        <h4 class="small font-weight-bold text-left" style="margin-left: 20px; margin-bottom: 30px; margin-right: 5px;">
                                            Penyajian Materi (Laporan/Presentasi)
                                            <span class="float-right">10%</span>
                                            <span class="float-right">
                                        ...
                                        <h4 class="small font-weight-bold text-left" style="margin-left: 20px; margin-bottom: 30px; margin-right: 12px;">
                                            Kedisiplinan / Sikap
                                        ...
                                        <h4 class="small font-weight-bold text-left" style="margin-left: 20px; margin-bottom: 30px; margin-right: 5px;">
                                            Keaktifan Asistensi (Kebaruan Materi)
                                            <span class="float-right">15%</span>
                                            <span class="float-right">
                                ...
                                <div style="margin-top: 30px; margin-right: 40px; margin-left: 30px;">
                                    ...
                                    <h4 class="small font-weight-bold text-left" style="width: 430px; margin-bottom: 45px; margin-left: 20px;">
                                        ...
                                        <a href="javascript:;" onclick="bimbingan()" class="btn btn-primary btn-icon-split" style="margin-top: 10px; width: 132px; margin-right: 10px;">
                                            <span class="text" style="font-size: 12px;">Bimbingan PKTI</span>
                                        </a>
                                        <a href="javascript:;" onclick="laporanNilai()" class="btn btn-primary btn-icon-split" style="margin-top: 10px; width: 132px; margin-right: 10px;">
                                            <span class="text" style="font-size: 12px;">Nilai PKTI</span>
                                        </a>
                                        <a href="javascript:;" onclick="laporan()" class="btn btn-primary btn-icon-split" style="margin-top: 10px; width: 132px;">
                                            <span class="text" style="font-size: 12px;">Laporan PKTI</span>
                                        </a>
...
<script type="text/javascript">
    ...
    function hitung() {
        var nilai = 
        (parseFloat($('#nilai_satu').val()) * 10 / 100) +
        (parseFloat($('#nilai_dua').val()) * 15 / 100) +
        (parseFloat($('#nilai_tiga').val()) * 20 / 100) +
        (parseFloat($('#nilai_empat').val()) * 10 / 100) +
        (parseFloat($('#nilai_lima').val()) * 15 / 100) +
        (parseFloat($('#nilai_enam').val()) * 10 / 100) +
        (parseFloat($('#nilai_tujuh').val()) * 5 / 100) +        
        (parseFloat($('#nilai_delapan').val()) * 15 / 100);
    ...
    function laporanNilai() {
         if ($('#kd_pkti_nilai').val().length == 0) {
            toastr.error('KD PKTI KOSONG', 'Maaf!');
        } else {
            window.open('<?= base_url(); ?>/pktiInternal/nilaiKu/'+$('#kd_pkti_nilai').val(), 'blank');
        }
    }
    ...
    function bimbingan() {
        if ($('#kd_pkti_nilai').val().length == 0) {
            ...
            window.open('<?= base_url(); ?>/pktiInternal/bimbingan/'+$('#kd_pkti_nilai').val(), 'blank');
        }
    }
    ...
    function laporan() {
        if ($('#kd_pkti_nilai').val().length == 0) {
            ...
            window.open('<?= base_url(); ?>/pktiInternal/laporan/'+$('#kd_pkti_nilai').val(), 'blank');
        }
    }
    ...
    function kdPMKP(kd) {
        $('#kd_pkti_nilai').val(kd);
    }

    function simpanData() {          
        if ($('#kd_pkti_nilai').val().length == 0) {
            toastr.error('Harap Masukan KD PKTI', 'Maaf!');
        } else {
            $("#form-data").submit();
        }
