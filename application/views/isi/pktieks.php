    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800" style="margin-top: 15px;">Pendaftaran & Kelengkapan Praktik Kerja Teknologi Informasi (Eksternal)</h1>
            </div>
...
<script type="text/javascript">
    ...
    function laporanNilai() {
         if ($('#kd_pkti_nilai').val().length == 0) {
            ...
            window.open('<?= base_url(); ?>/pktiEksternal/nilaiKu/'+$('#kd_pkti_nilai').val(), 'blank');
        }
    }
    ...
    function bimbingan() {
        if ($('#kd_pkti_nilai').val().length == 0) {
            ...
            window.open('<?= base_url(); ?>/pktiEksternal/bimbingan/'+$('#kd_pkti_nilai').val(), 'blank');
        }
    }
    ...
    function laporan() {
        if ($('#kd_pkti_nilai').val().length == 0) {
            ...
            window.open('<?= base_url(); ?>/pktiEksternal/laporan/'+$('#kd_pkti_nilai').val(), 'blank');
        }
    }
