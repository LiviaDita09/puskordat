    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800" style="margin-top: 15px;">Pendaftaran & Kelengkapan Pengabdian Mahasiswa Kepada Masyarakat (Eksternal)</h1>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="card shadow mb-4" style="width: 1078px;">
                        ...
                        <form method="post" action="<?php echo base_url('pmkmEksternal/saveData'); ?>" id="form-data">
                    ...
                    <div class="card shadow mb-4" style="width: 1078px; height: 500px;">
                        ...
                        <div class="row text-center">
                            <div class="card-body" style="width: 450px; margin-top: 5px;">
                                <form method="post" action="<?php echo base_url('pmkmEksternal/saveNilai');?>" id="form-nilai">
                                    <div style="margin-right: 40px; margin-left: 40px;">
                                        ...
                                        <h4 class="small font-weight-bold text-left" style="margin-left: 20px; margin-bottom: 30px; margin-right: 5px;">
                                            Identifikasi dan Analisis Masalah / Topik
...
<script type="text/javascript">
    ...
    function laporanNilai() {
         if ($('#kd_pmkm_nilai').val().length == 0) {
            ...
            window.open('<?= base_url(); ?>/pmkmEksternal/nilaiKu/'+$('#kd_pmkm_nilai').val(), 'blank');
        }
    }
    ...
    function bimbingan() {
        if ($('#kd_pmkm_nilai').val().length == 0) {
            ...
            window.open('<?= base_url(); ?>/pmkmEksternal/bimbingan/'+$('#kd_pmkm_nilai').val(), 'blank');
        }
    }
    ...
    function laporan() {
        if ($('#kd_pmkm_nilai').val().length == 0) {
            ...
            window.open('<?= base_url(); ?>/pmkmEksternal/laporan/'+$('#kd_pmkm_nilai').val(), 'blank');
        }
    }
