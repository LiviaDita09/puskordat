...
<html>
<head>
	<title>PENILAIAN PKTI EKSTERNAL</title>
</head>
<body>
	<img src="<?= base_url('files/nilaiPKTIexternal.png'); ?>" style="width: 100%;">
...
Akademik 2018/2019 oleh Mahasiswa:</p>
	...
	<table border="1" style="width: 100%;">
		...
		<tr>
			...
			<td style="padding: 10px;">Identifikasi dan analisis</td>
			<td style="padding: 10px; text-align: center;">10%</td>
			<td style="padding: 10px;"></td>
		</tr>
		<tr>
			<td style="padding: 10px; text-align: center;">2</td>
			<td style="padding: 10px;">Keterampilan langkah kerja</td>
			<td style="padding: 10px; text-align: center;">15%</td>
			<td style="padding: 10px;"></td>
		</tr>
		<tr>
			<td style="padding: 10px; text-align: center;">3</td>
			<td style="padding: 10px;">Kreativitas kerja</td>
			<td style="padding: 10px; text-align: center;">20%</td>
			<td style="padding: 10px;"></td>
		</tr>
		<tr>
			<td style="padding: 10px; text-align: center;">4</td>
			<td style="padding: 10px;">Kualitas hasil kerja</td>
			<td style="padding: 10px; text-align: center;">10%</td>
			<td style="padding: 10px;"></td>
		</tr>
		<tr>
			<td style="padding: 10px; text-align: center;">5</td>
			<td style="padding: 10px;">Kemampuan komunikasi dan adaptasi</td>
			<td style="padding: 10px; text-align: center;">10%</td>
			<td style="padding: 10px;"></td>
		</tr>
		<tr>
			<td style="padding: 10px; text-align: center;">6</td>
			<td style="padding: 10px;">Kedisiplinan</td>
			<td style="padding: 10px; text-align: center;">10%</td>
			<td style="padding: 10px;"></td>
		</tr>
		<tr>
			<td style="padding: 10px; text-align: center;">7</td>
			<td style="padding: 10px;">Sikap dan tingkah laku umum</td>
			<td style="padding: 10px; text-align: center;">5%</td>
			<td style="padding: 10px;"></td>
		</tr>
		<tr>
			<td style="padding: 10px; text-align: center;">8</td>
			<td style="padding: 10px;">Tanggung jawab</td>
			<td style="padding: 10px; text-align: center;">15%</td>
			<td style="padding: 10px;"></td>
		</tr>
	</table>
