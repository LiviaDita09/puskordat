...
class PktiEksternal extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('isi/pktieks', $temp);
    ...
    function bimbingan($kd) {
        ...
        $this->load->view('isi/pkti/external_bimbingan', $temp);
    }
    ...
    function laporan($kd) {
        ...
        $this->load->view('isi/pkti/external_laporan', $temp);
    }
    ...
    function nilaiKu($kd) {
        ...
        $this->load->view('isi/pkti/external_nilai', $temp);
    }
}