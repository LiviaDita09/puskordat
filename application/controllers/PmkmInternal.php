...
class PmkmInternal extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('isi/pmkmin', $temp);
    ...
    function bimbingan($kd) {
        ...
        $this->load->view('isi/pmkm/bimbinganInternal', $temp);
    }
    ...
    function laporan($kd) {
        ...
        $this->load->view('isi/pmkm/laporanInternal', $temp);
    }
    ...
    function nilaiKu($kd) {
        ...
        $this->load->view('isi/pmkm/nilaiInternal', $temp);
    }
}